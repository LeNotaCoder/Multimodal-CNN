...
from custom_models import CNNWithLSTMBlocks, fundus_vgg16, oct_fine_feat, FinalDualModel, Dualbranch
...
model.load_state_dict(torch.load(f"{sys_path}LSTM/lstm_oct_model.pth"))  # load weights
